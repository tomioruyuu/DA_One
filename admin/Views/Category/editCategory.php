...
<div class="d-flex">
    ...
    <div class="main-content body-content mt20">
        <div class="list_product-heading df-center align-items-center">
            ...
            <h1 class="title-list-product">Sửa danh mục sản phẩm</h1>
        </div>
        <form action="" method="post" enctype="multipart/form-data" class="add-product_content mt20">
            <div class="block">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name_cate" class="form-control" value="<?php echo $itemCate->name ?>">
                    <p class="text-danger"><?php echo isset($errors["name_cate"]) ? $errors["name_cate"]["required"] : null ?></p>
                </div>
            </div>
            <div class="cta-form mt20">
                <button type="submit" class="btn btn-form " value="them" name="btn-submit">Sửa danh mục</button>
