...
class Cart
{
    ...
    {
        $sql = "SELECT p.name, p.img, cart.id, cart.quantity, cart.price * cart.quantity as price, cart.size FROM `cart` INNER JOIN products as p ON cart.id_products = p.id WHERE cart.id_user = ?";
