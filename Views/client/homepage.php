...
<div class="main-content">
        ...
        <div id="carouselExampleRide" class="carousel slide" data-bs-ride="true">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./modules/images/slider_7.webp" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./modules/images/slider5.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./modules/images/slide_6_img.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
    ...
    <section class="cate-img mt-30 d-flex align-items-center justify-content-between">
        ...
        ?>
            <a href="?act=search&id_category=<?php echo $item->id ?>">
    ...
    <section class="new-collection">
        ...
        <a href="?act=product" class="btn btn-more mt20">Xem thêm</a>
    </section>
